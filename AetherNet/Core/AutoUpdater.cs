...
namespace AetherNet.Core
{
    ...
    {
        private const string UPDATE_URL = "https://raw.githubusercontent.com/stefanraskovic/AetherNet/main/version.json";
        private const string DOWNLOAD_URL = "https://github.com/stefanraskovic/AetherNet/releases/latest/download/AetherNet.exe";
